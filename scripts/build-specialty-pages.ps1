    ...
    <script type="application/ld+json">
    {
      ...
      "breadcrumb": {
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 2, "name": "Spell Casters", "item": "https://thestarcatalog.com/index.html" },
...
<body>
    ...
    <nav class="lsc-breadcrumb" aria-label="Breadcrumb">
        ...
        <a href="index.html">All Spell Casters</a>
        <span class="lsc-breadcrumb-sep" aria-hidden="true">&rsaquo;</span>
    ...
    <section class="lsc-hero" aria-labelledby="lscH1">
        ...
        <div class="lsc-cta-row">
            ...
            <a href="index.html" class="landing-btn-secondary light">Browse All Spell Casters</a>
        </div>
    </section>
