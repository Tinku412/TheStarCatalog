 ...
 *   hex-and-curse-removal.html, cord-cutting-practitioners.html, banishment-spell-casters.html,
    ...
    el.innerHTML = `
        <div class="footer-top">
            <div class="footer-col">
                <div class="footer-col-title">The Star Catalog</div>
                <div style="display:flex;align-items:center;gap:9px;margin-bottom:10px;">
                    ...
                    <span style="font-family:'Cinzel',serif;font-size:12px;color:var(--cream);letter-spacing:0.1em;">thestarcatalog</span>
                </div>
                <p class="footer-logo-desc">A community-run directory of spell casters and spiritual practitioners. Real reviews from real people — built to protect seekers from fraud.</p>
            </div>
            <div class="footer-col">
            ...
            <div class="footer-col">
                ...
                <ul class="footer-links">
                    ...
                    <li><a href="cord-cutting-practitioners.html">Cord Cutting Practitioners</a></li>
        ...
        <div class="footer-bottom">
            <span class="footer-copy">© MMXXVI The Star Catalog. All rights reserved.</span>
